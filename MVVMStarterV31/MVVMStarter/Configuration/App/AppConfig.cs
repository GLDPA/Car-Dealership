namespace MVVMStarter.Configuration.App
{
    ...
    public static class AppConfig
    {
        ...
        public static void Setup()
        {
            ...
            LoadModels += Models.Domain.Photo.DomainModel.Instance.Load;
            SaveModels += Models.Domain.Photo.DomainModel.Instance.Save;

            LoadModels += Models.Domain.Pair.DomainModel.Instance.Load;
            SaveModels += Models.Domain.Pair.DomainModel.Instance.Save;
