...
namespace MVVMStarter.ViewModels.Domain.Pair
{
    public class MasterDetailsViewModel : MasterDetailsViewModelBase<PairClass>
    {
        public MasterDetailsViewModel() 
            : base(new ViewModelFactory(), Models.Domain.Pair.DomainModel.Instance)
        {
        ...
        {
            get { return new SwapController(this, Models.Domain.Pair.DomainModel.Instance, ItemViewModelSelected?.DomainObject); }
        }
